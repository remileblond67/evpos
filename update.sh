...
for cmd in import_baza import_suapp import_poste report_util_poste import_acces_appli import_acces_uo import_acces_poste report_acces_poste report_acces_service
do
    echo "*********************************************"
